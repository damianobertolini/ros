...
int main(){
    ...
    //pinocchio::urdf::buildModel("~/ros_ws/src/robo/ros/robot_urdf/generated_urdf/ur5.urdf",model);
...
// PINOCCHIO_MODEL_DIR is defined by the CMake but you can define your own directory here.
  ...
  #define PINOCCHIO_MODEL_DIR "~/ros_ws/src/robo/ros/robot_urdf/generated_urdf"
#endif
